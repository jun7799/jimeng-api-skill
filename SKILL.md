...
TRIGGER when: 用户请求生成图片、生成视频、AI绘图、AI视频、即梦相关任务，或代码中涉及 jimeng API 调用
...
class JimengAPI:
    ...
    API_KEY = "<你的sessionid>"  # 替换成你的 sessionid
...
if __name__ == "__main__":
    api = JimengAPI(api_key="<你的sessionid>")  # 替换成你的 sessionid
...
- [jimeng-free-api-all 项目](https://github.com/zhizinan1997/jimeng-free-api-all)
